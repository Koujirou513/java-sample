...
-- 販売実績データ挿入（過去1週間分）
INSERT INTO sales (date, weather, created_by, created_at, updated_at) VALUES 
    (CURRENT_DATE - 7, 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (CURRENT_DATE - 6, 2, 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (CURRENT_DATE - 5, 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (CURRENT_DATE - 4, 3, 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (CURRENT_DATE - 3, 2, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (CURRENT_DATE - 2, 1, 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (CURRENT_DATE - 1, 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
